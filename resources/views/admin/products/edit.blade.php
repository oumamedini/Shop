                                            ...
                                            <div class="col-md-4">
                                                <div class="info-box bg-info">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <span class="info-box-number">{{ $product->orders_count ?? 0 }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="info-box bg-success">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <span class="info-box-number">${{ number_format($product->total_revenue ?? 0, 2) }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="info-box bg-warning">
                                                    ...
                                                    <div class="info-box-content">
                                                        ...
                                                        <span class="info-box-number">{{ number_format($product->average_rating ?? 0, 1) }}/5.0</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
